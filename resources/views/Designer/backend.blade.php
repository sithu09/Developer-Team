...
<html lang="en">
  <head>
    ...
    <title>Designer to Backend</title>
    <!-- Bootstrap CSS -->
      ...
      <div class="container box_1620">
        <div class="banner_inner d-flex align-items-center">
          <div class="banner_content">
            <div class="media">
              <div class="d-flex">
                <img src="../team/img/backend.jpg" alt="" />
              </div>
              <div class="media-body">
                <div class="personal_text">
                  <h3>Moe Kyaw Swar Aung</h3>
        ...
        <div class="table">
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">{{ $backend->member_no}}</th>
                <td>{{ $backend->project_id}}</td>
                <td>{{$backend->task_name}}</td>
                <td>{{ $backend->task_short_name}}</td>
              </tr>
            </tbody>
          </table>
        </div>
