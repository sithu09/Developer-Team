...
<html lang="en">
  <head>
    ...
    <title>Designer to Team Leader</title>
    <!-- Bootstrap CSS -->
          ...
          <div class="container box_1620">
            ...
            >
              <ul class="nav navbar-nav menu_nav ml-auto">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('designer/frontend')}}">Frontend</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('designer/backend')}}">Backend</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('designer/team_leader')}}">Team-Leader</a>
                </li>
               <li class="nav-item">
      ...
      <div class="container box_1620">
        <div class="banner_inner d-flex align-items-center">
          <div class="banner_content">
            <div class="media">
              <div class="d-flex">
                <img src="../team/img/leader.jpg" alt="" / style="width:550px;height:750px">
              </div>
              <div class="media-body">
                <div class="personal_text">
                  <h3>Phone Thet Paing Htoo</h3>
                  <h4>Team Leader</h4>
      ...
      <div class="container p-5">
        ...
        <div class="table">
          <table class="table table-striped">
            ...
            <tbody>
                @foreach ($tleaders as $tleader)
              <tr>
                <th scope="row">{{$tleader->member_no}}</th>
                <td>{{ $tleader->project_id}}</td>
                <td>{{$tleader->task_name}}</td>
                <td>{{$tleader->task_short_name}}</td>
              </tr>
            </tbody>
          </table>
        </div>
