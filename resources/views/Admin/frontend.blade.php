...
<li class="nav-item">
      ...
      <div class="container">
        <div class="banner_inner d-flex align-items-center">
          <div class="banner_content">
            <div class="media">
              <div class="d-flex">
                <img src="../team/img/frontend.png" alt="" / style="width:370px;height:400px">
              </div>
   ...
   <div class="text-info mb-4"><h1 class="text-center">Update Project Form</h1> <hr style="border: 2px solid #742; width: 200px;" /> <h5 class="text-center">
     ...
     <form method="POST" action="/admin_frontend_project_form"  class="form-inline update">
    @csrf
  ...
  <button type="submit" class="btn btn-primary mb-2">Update</button>
        ...
        <div class="text-info p-3 text-justify">
          ...
          <p>{{ $frontend->task_member_status}}</p>
        </div>
        <div class="text-info p-3 text-justify">
          ...
          <hr style="border: 2px solid #742; width: 200px;" />
          <form method="POST" action="/admin_command_frontend">
    @csrf
