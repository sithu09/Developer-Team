...
<html lang="en">
  <head>
    ...
    <title>Admin ToDo List Insert</title>
...
<li class="nav-item">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <!-- End of Topbar -->
        <div class="container">
          <div class="bg-primary text-center"><h2 class="text-white py-1">ToDo List Insert Form</h2></div>
          <div class="form mt-3">
             <form method="POST" action="/todo_list_insert">
    @csrf

  <div class="form-group">
    <input type="text" name="project_no" class="form-control" placeholder="Enter project no">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <input type="text" name="task_short_name" class="form-control"  placeholder="Task Short Name">
  </div>
  <div class="form-group">
    <input type="text" name="start_date" class="form-control"  placeholder="Start Date">
  </div>
  <div class="form-group">
    <input type="text" name="dead_line" class="form-control"  placeholder="Dead line">
  </div>
