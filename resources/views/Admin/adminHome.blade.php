...
<li class="nav-item">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <!-- End of Topbar -->
        <div class="container">
          <div class="bg-primary text-center"><h1 class="text-white">ToDo List</h1></div>
...
@foreach ($todos as $todo)
    <tr>
                ...
                <td scope="row" name="project_no" >{{ $todo->project_no }}</td>
                <td>{{ $todo->project_id }}</td>
                <td>{{  $todo->task_name }}</td>
                <td>{{  $todo->task_short_name }}</td>
                <td>{{ $todo->begin}}</td>
                <td>{{ $todo->over }}</td>
                <td><a href='/todo_list_delete/{{ $todo->id }}' class="btn btn-secondary active" role="button" aria-pressed="true">Delete</a></td>
              </tr>
@endforeach
