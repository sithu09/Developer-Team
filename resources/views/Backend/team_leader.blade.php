...
<html lang="en">
  <head>
    ...
    <title>Backend to Team Leader</title>
    <!-- Bootstrap CSS -->
          ...
          <div class="container box_1620">
            ...
            >
              <ul class="nav navbar-nav menu_nav ml-auto">
                 <li class="nav-item">
                  <a class="nav-link" href="{{url('backend/designer')}}">Designer</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('backend/frontend')}}">Frontend</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('backend/team_leader')}}">Team-Leader</a>
                </li>
                 <li class="nav-item">
