...
<html lang="en">
  <head>
    ...
    <title>Backend to Frontend</title>
    <!-- Bootstrap CSS -->
      ...
      <div class="container box_1620">
        <div class="banner_inner d-flex align-items-center">
          <div class="banner_content">
            <div class="media">
              <div class="d-flex">
                <img src="../team/img/frontend.png" alt="" />
              </div>
              <div class="media-body">
                <div class="personal_text">
                  <h3>Thet Su Tun Naing</h3>
        ...
        <div class="table">
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">{{ $frontend->member_no}}</th>
                <td>{{ $frontend->project_id}}</td>
                <td>{{$frontend->task_name}}</td>
                <td>{{ $frontend->task_short_name}}</td>
              </tr>
            </tbody>
          </table>
        </div>
