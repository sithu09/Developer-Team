...
<html lang="en">
  <head>
    ...
    <title>Frontend to Team Leader</title>
    <!-- Bootstrap CSS -->
          ...
          <div class="container box_1620">
            ...
            >
              <ul class="nav navbar-nav menu_nav ml-auto">
                 <li class="nav-item">
                  <a class="nav-link" href="{{url('frontend/designer')}}">Designer</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('frontend/backend')}}">Backend</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('frontend/team_leader')}}">Team-Leader</a>
                </li>
                 <li class="nav-item">
